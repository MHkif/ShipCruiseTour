...
<div class="h-screen md:flex">
	<div
		...
		<div>
			<h1 class="text-white font-bold text-4xl font-sans">RoyalNorth</h1>
			<p class="text-white mt-1">The most popular ship tour in the world</p>
	...
	<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form class="bg-white">
			...
			<p class="text-sm font-normal text-gray-600 mb-7">Welcome To RoyalNorth</p>
