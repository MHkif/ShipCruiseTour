...
<aside class="py-2 w-64 shadow-sm bg-white fixed left-0  min-h-screen">
            <div class="px-3 py-4 overflow-y-auto rounded">
                <ul class="space-y-2">
                    ...
                    <li class="p-0.2 bg-orange-500 rounded">
                        <a href="<?php echo URLROOT ?>/admin/reservations"  class="flex items-center p-2 text-base font-medium text-white rounded dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                        >
    ...
    <main class="ml-64 flex-1 overflow-x-scroll px-4 ">
        <div class="flex items-center justify-between py-7 px-2">
            ...
            <button class="inline-flex gap-x-2 items-center py-2.5 px-6 text-white bg-orange-600 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1">
