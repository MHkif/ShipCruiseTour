                        ...
                        <div class="px-4 py-8 lg:px-6 flex flex-col gap-8">
                            ...
                            <form class="space-y-4" action="<?php echo URLROOT ?>/ship/createShip" method="POST" enctype="multipart/form-data">
                                ...
                                <!-- <div class="w-full">
                                    ...
                                    <input type="number" name="places" id="places" class="bg-white border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Ship's places number">
                                </div> -->
