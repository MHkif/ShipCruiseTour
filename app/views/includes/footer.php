        ...
        <div class="w-full flex flex-col flex-wrap sm:grid grid-cols-2 md:grid-cols-3 justify-items-center content-center lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-10" >
            ...
            <div class="flex flex-col flex-shrink-0" style="font-family: 'Poppins', sans-serif;">
                ...
                <div class="flex items-center gap-x-4 mt-12">
                    <button aria-label="instagram" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-800 opacity-75 w-8 h-8 flex-shrink-0 bg-orange-600 cursor-pointer hover:bg-orange-400 rounded-full flex items-center justify-center">
                    ...
                    <button aria-label="linked-in" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-800 opacity-75 w-8 h-8 flex-shrink-0 bg-orange-600 cursor-pointer hover:bg-orange-400 rounded-full flex items-center justify-center">
                        <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button aria-label="twitter" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-800 opacity-75 w-8 h-8 flex-shrink-0 bg-orange-600 cursor-pointer hover:bg-orange-400 rounded-full flex items-center justify-center">
                    ...
                    <button aria-label="youtube" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-800 opacity-75 w-8 h-8 flex-shrink-0 bg-orange-600 cursor-pointer hover:bg-orange-400 rounded-full flex items-center justify-center">
            ...
            <div class="flex flex-col" style="font-family: 'Poppins', sans-serif;">
                ...
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Group Travel</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Cruise Tips and Triks</a>
            ...
            <div class="flex flex-col"  style="font-family: 'Poppins', sans-serif;">
                ...
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Mediterranean Cruises</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Bahamas Cruises</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">European Cruises</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Hawaii Cruises</a>

            </div>
            <div class="flex flex-col" style="font-family: 'Poppins', sans-serif;">
                <h2 class="text-base font-semibold leading-4 text-gray-800 dark:text-white" style="font-family: 'Prosto One', cursive;">Popular Ports</h2>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Tanger, Casablanca</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Miami, Florida</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">New York, New York</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Baltimore, Maryland</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Sab Juan, Puerto</a>
                <a href="javascript:void(0)" class="focus:outline-none focus:underline hover:text-orange-500 text-base leading-4 mt-6 text-gray-600 font-thin dark:text-white cursor-pointer">Barcelona, Spain</a>
        ...
        <!-- <div class="w-full flex justify-center items-center">
            <div class="mt-10 w-96">
                ...
                <div class="flex gap-4 mt-4">
                    <input type="Email" class="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Email" aria-label="Email" aria-describedby="button-addon2">
